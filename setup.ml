...
(* OASIS_START *)
(* DO NOT EDIT (digest: 296f865cab8cc23db909062412fa5624) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/akabe/ocaml-crf";
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Crf"; "Crf_graph"; "Crf_model"; "Crf_core"];
                      lib_pack = false;
                      lib_internal_modules =
                        ["Crf_distrib"; "Crf_naive"; "Crf_sampling"; "Crf_sa"
                        ];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "crf";
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Odoc_custom"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "odoc_custom";
                      lib_findlib_containers = []
                   });
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "OCaml-CRF API Documentation";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "5.\139\023\028\217<\129\235\208\226>\161t\"\023";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
